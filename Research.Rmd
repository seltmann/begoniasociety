...
A related question guiding my research is how we can employ computational tools with cloud and semantic information processing to advance research on digitized biodiversity collections, through data analysis and mining for pattern discovery, and through automated quality control of information. Such tools furnish transformative methodologies that are dramatically reshaping the kinds of research questions we can address.
